...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnMale.setOnClickListener {
            btnMale.setBackgroundColor(Color.parseColor("#FF03A9F4"))
            btnFemale.setBackgroundColor(Color.parseColor("#00BCD4"))
        }
        btnFemale.setOnClickListener {
            btnFemale.setBackgroundColor(Color.parseColor("FF03A9F4"))
            btnMale.setBackgroundColor(Color.parseColor("#00BCD4"))
        }
